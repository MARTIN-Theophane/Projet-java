...
static void redemarrer_pos_anim(ArrayList<Animatronique> animatroniques, ArrayList<Piece> pieces,Joueur[] joueur, int[][] chemin) {
	...
	static void Jumpscare(Animatronique animatronique,Piece piece) {
		...
		} else if (piece.getPopulation().size() > 1) {
			if (piece.getPopulation().get(1).getNum_position() == 16) {
				JFrame frame1 = new JFrame("Mon jeu");
				frame1.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
				Dimension screenSize1 = Toolkit.getDefaultToolkit().getScreenSize();
				int largeur1 = screenSize1.width;
		...
		} else if (piece.getPopulation().size() > 2) {
			if (piece.getPopulation().get(2).getNum_position() == 16) {
				JFrame frame1 = new JFrame("Mon jeu");
		        frame1.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		        Dimension screenSize1 = Toolkit.getDefaultToolkit().getScreenSize();
		        int largeur1 = screenSize1.width;
		...
		} else if (piece.getPopulation().size() > 3) {
			if (piece.getPopulation().get(3).getNum_position() == 16) {
				JFrame frame1 = new JFrame("Mon jeu");
				frame1.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
				Dimension screenSize1 = Toolkit.getDefaultToolkit().getScreenSize();
				int largeur1 = screenSize1.width;
