...
static void redemarrer_pos_anim(ArrayList<Animatronique> animatroniques, ArrayList<Piece> pieces,Joueur[] joueur, int[][] chemin) {
	...
	static void Jumpscare(Animatronique animatronique,Piece piece) {
		...
		case 1 :
			/*if (piece.getPopulation().get(0).getNum_position() == 16 && piece.getPopulation().get(0).getId_espece() == 0) {
		        ...
		        try {
		        	iconOriginal1 = new ImageIcon(get_adresse_image("Jumpscare B"));
		        } catch (Exception e) {
		            e.printStackTrace();
		        }
				...
				try {
					...
					try {
						audio = AudioSystem.getAudioInputStream(new File(get_adresse_son("Jumpscare")));
					} catch (Exception e) {
						e.printStackTrace();
					}
				...
				System.exit(0);
			} else if (piece.getPopulation().get(0).getNum_position() == 16 && piece.getPopulation().get(0).getId_espece() == 1) {
				JFrame frame1 = new JFrame("Mon jeu");
				frame1.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
				Dimension screenSize1 = Toolkit.getDefaultToolkit().getScreenSize();
				int largeur1 = screenSize1.width;
				...
				System.exit(0);
			} else*/ if (piece.getPopulation().get(0).getNum_position() == 16 && piece.getPopulation().get(0).getId_espece() == 2) {
				JFrame frame1 = new JFrame("Mon jeu");
		        frame1.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		        Dimension screenSize1 = Toolkit.getDefaultToolkit().getScreenSize();
		        int largeur1 = screenSize1.width;
		        ...
		        ImageIcon iconOriginal1 = new ImageIcon();
		        try {
		        	iconOriginal1 = new ImageIcon(get_adresse_image("Jumpscare F"));
		        } catch (Exception e) {
		            e.printStackTrace();
		        }
		        Image imageRedim1 = iconOriginal1.getImage().getScaledInstance(largeur1, hauteur1, Image.SCALE_SMOOTH);
		        ...
		        System.exit(0);
			} /*else if (piece.getPopulation().get(0).getNum_position() == 16 && piece.getPopulation().get(0).getId_espece() == 3) {
				JFrame frame1 = new JFrame("Mon jeu");
				frame1.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
				Dimension screenSize1 = Toolkit.getDefaultToolkit().getScreenSize();
				int largeur1 = screenSize1.width;
				...
				ImageIcon iconOriginal1 = new ImageIcon();
		        try {
		        	iconOriginal1 = new ImageIcon(get_adresse_image("Jumpscare Fr"));
		        } catch (Exception e) {
		            e.printStackTrace();
		        }
				Image imageRedim1 = iconOriginal1.getImage().getScaledInstance(largeur1, hauteur1, Image.SCALE_SMOOTH);
		...
		if (lumiere.getOccupe() == true) {
			if (piece.getPopulation().size() > 0) {
				if(piece.getPopulation().get(0).getNum_position() == 15) {
			        ...
			        ImageIcon iconOriginal1 = new ImageIcon();
			        try {
			        	iconOriginal1 = new ImageIcon(get_adresse_image("Porte B"));
			        } catch (Exception e) {
			            e.printStackTrace();
			        }
			        Image imageRedim1 = iconOriginal1.getImage().getScaledInstance(largeur1, hauteur1, Image.SCALE_SMOOTH);
			        ...
			        try {
			        	AudioInputStream audio = null;
						try {
							audio = AudioSystem.getAudioInputStream(new File(get_adresse_son("Porte anim")));
						} catch (Exception e) {
							e.printStackTrace();
						}
			        ...
			        ImageIcon iconOriginal1 = new ImageIcon();
			        try {
			        	iconOriginal1 = new ImageIcon(get_adresse_image("Bureau LG"));
			        } catch (Exception e) {
			            e.printStackTrace();
			        }
			        Image imageRedim1 = iconOriginal1.getImage().getScaledInstance(largeur1, hauteur1, Image.SCALE_SMOOTH);
		...
		if (lumiere.getOccupe() == true) {
			if (piece.getPopulation().size() > 0) {
				if(piece.getPopulation().get(1).getNum_position() == 15) {
					...
					ImageIcon iconOriginal1 = new ImageIcon();
			        try {
			        	iconOriginal1 = new ImageIcon(get_adresse_image("Porte C"));
			        } catch (Exception e) {
			            e.printStackTrace();
			        }
					Image imageRedim1 = iconOriginal1.getImage().getScaledInstance(largeur1, hauteur1, Image.SCALE_SMOOTH);
				    ...
				    ImageIcon iconOriginal1 = new ImageIcon();
			        try {
			        	iconOriginal1 = new ImageIcon(get_adresse_image("Bureau LD"));
			        } catch (Exception e) {
			            e.printStackTrace();
			        }
				    Image imageRedim1 = iconOriginal1.getImage().getScaledInstance(largeur1, hauteur1, Image.SCALE_SMOOTH);
	...
	static void porteVide(Lumière lumiere_gauche, Lumière lumiere_droite, Joueur joueur) {
		if ((joueur.getChangement_lumiere_gauche() == 'E') || (joueur.getChangement_lumiere_droite() == 'E')) {
			Window[] fenetres = Window.getWindows();
			int i;
			for (i = 0; i < fenetres.length; i++) {
		        String t = null;

		        if (fenetres[i] instanceof JFrame f) {
		        	t = f.getTitle();
		        }
		        if ("Lumiere".equals(t)) {
		        	fenetres[i].dispose();
			...
			JFrame frame1 = new JFrame("Lumiere");
            ...
            ImageIcon iconOriginal1 = new ImageIcon();
	        try {
	        	iconOriginal1 = new ImageIcon(get_adresse_image("Bureau"));
	        } catch (Exception e) {
	            e.printStackTrace();
	        }
            Image imageRedim1 = iconOriginal1.getImage().getScaledInstance(largeur1, hauteur1, Image.SCALE_SMOOTH);
            ...
            frame1.setExtendedState(JFrame.MAXIMIZED_BOTH); // maximise la fenêtre
            frame1.setVisible(true);
            joueur.setChangement_lumiere_gauche('F');
            joueur.setChangement_lumiere_droite('F');
        } else if (joueur.getChangement_lumiere_droite() == 'A') {
			Window[] fenetres = Window.getWindows();
			int i;
			for (i = 0; i < fenetres.length; i++) {
		        String t = null;
            ...
            frame1.setVisible(true);
            joueur.setChangement_lumiere_droite('F');
        } else if (joueur.getChangement_lumiere_gauche() == 'A') {
			Window[] fenetres = Window.getWindows();
			int i;
			for (i = 0; i < fenetres.length; i++) {
		        String t = null;
...
// Animatronique(id espece, position animatronique)
		...
		Lumière lumiere_gauche = new Lumière(1,true);
		Lumière lumiere_droite = new Lumière(2,true);
...
/*---------------------------------------------------------------------------------------------------------------*/	
		...
		Thread t2 = new Thread(() -> {
		    while (true) {
		    	...
		    	if (joueur[0] != null) {
		    		porteVide(lumiere_gauche,lumiere_droite,joueur[0]);
		    	}
		    }
		});
